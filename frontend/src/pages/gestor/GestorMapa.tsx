    ...
    <div className="space-y-6 animate-fade-in-up">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-3xl border border-slate-200/80 shadow-xs">
        <div>
          <div className="inline-flex items-center gap-2 bg-[#1B7547]/10 text-[#1B7547] px-3 py-1 rounded-full text-xs font-extrabold uppercase tracking-wider mb-2">
            ...
            <span>Geoprocessamento Unificado MS</span>
          </div>
        ...
        <button
          ...
          className="group relative flex items-center gap-2 bg-slate-100 hover:bg-[#1B7547] text-slate-700 hover:text-white px-5 py-3 rounded-2xl font-extrabold text-xs transition-all duration-300 shadow-xs hover:shadow-lg active:scale-95 cursor-pointer shrink-0"
        >
          <RefreshCw className={`w-4 h-4 transition-transform group-hover:rotate-180 duration-500 ${loading ? 'animate-spin' : ''}`} />
          <span>Atualizar Geometrias</span>
        </button>
      </div>

      {/* Cards de Métricas em Tempo Real com Motion */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-3xl border border-slate-200/80 shadow-xs hover:shadow-lg transition-all duration-300 flex items-center gap-4 group">
          ...
          <div>
            <div className="text-2xl font-extrabold text-slate-900 tracking-tight">{totalCount}</div>
            <div className="text-xs text-slate-500 font-extrabold uppercase tracking-wider">Fazendas Visíveis</div>
          </div>
        </div>
